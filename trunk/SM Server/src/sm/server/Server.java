...
public class Server implements Runnable{
	...
	InetAddress ClientIPAddr; // endere�o IP do cliente
	...
	public void run() {
		...
		// se o numero da imagem atual � menor que o tamanho do video
	...
	public static void start(int porta, SMServerActivity ac) throws Exception {
		...
		// la�o para controlar requisi��es RTP
		//while (true) {
